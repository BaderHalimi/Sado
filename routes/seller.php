...
Route::group(['namespace' => 'Seller', 'prefix' => 'seller', 'as' => 'seller.'], function () {
    ...
    Route::group(['middleware' => ['seller']], function () {
        ...
        Route::group(['prefix' => 'product', 'as' => 'product.'], function () {
            ...
            Route::get('room-list', 'ProductController@roomList')->name('room-list');
            Route::delete('room-delete/{id}', 'ProductController@roomDelete')->name('room-delete');
            Route::get('add-new-room/{room_id}', 'ProductController@add_new_room')->name('add-new-room');
        ...
        Route::group(['prefix' => 'orders', 'as' => 'orders.'], function () {
            ...
            Route::post('address-update', 'OrderController@address_update')->name('address-update');// update address from order details
              // مسارات StarLinks API
    Route::post('create-order-shipment', 'OrderController@createOrderShipment')->name('create-order-shipment');
    Route::get('track-order-shipment/{trackingNumber}', 'OrderController@trackOrderShipment')->name('track-order-shipment');
