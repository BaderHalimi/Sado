...
function () {
    ...
    /*authentication*/
    Route::group(
        ['namespace' => 'Auth', 'prefix' => 'auth', 'as' => 'auth.'],
        function () {
    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::group(['prefix' => 'sellers', 'as' => 'sellers.','middleware'=>['module:user_section']], function () {
            ...
            Route::post('settings-password/{id}', 'SellerController@settings_password_update')->name('settings-password');
        ...
        Route::group(['prefix' => 'orders', 'as' => 'orders.','middleware'=>['module:order_management']], function () {
            ...
            Route::get('show-invoice/{id}', 'OrderController@show_invoice')->name('show-invoice')->withoutMiddleware(['module:order_management']);
