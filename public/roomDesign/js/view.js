...
var ContextMenu = function(blueprint3d, sideMenu) {
...
var mainControls = function(blueprint3d, productManager) {
  ...
  function onDesignSaveBtn() {
    ...
    $.post(addToSaleURL, {data : data, image: image, name: name, price: price, _token: _token}, function(data) {
...
$(document).ready(function() {
  ...
  var contextMenu = new ContextMenu(blueprint3d, sideMenu);
