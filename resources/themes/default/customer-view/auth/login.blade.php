    ...
    <div class="container py-4 py-lg-5 my-4"
         ...
         <div class="login-card">
            <div class="mx-auto __max-w-360">
                ...
                <form class="needs-validation mt-2" autocomplete="off" action="{{route('customer.auth.login')}}"
                    ...
                    <div class="form-group">
                        ...
                        <div class="password-toggle rtl">
                            <input class="form-control" name="password" type="password" id="si-password" placeholder="{{translate('enter_password')}}"
                                    style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};"
                                    required>
                ...
                <div dir="rtl" class="text-black-50 text-center">
                    <label>
                        <span class="fw-bold">
