...
@section('content')
    <div dir="{{ Session::get('direction') }}" class="container py-4 __inline-7"
        ...
        <div class="login-card">
            <div class="mx-auto __max-w-760">
                ...
                <form class="needs-validation_" id="form-id" action="{{route('customer.auth.sign-up')}}"
                            ...
                            <div class="rtl">
                                <label class="custom-control custom-checkbox m-0 d-flex">
                                    ...
                                    <span class="custom-control-label text-primary">
                                        <span class="text-primary">{{ translate('i_agree_to_Your')}}</span> <a class="font-size-sm text-primary" target="_blank" href="{{route('terms')}}">{{ translate('terms_and_condition')}}</a>
                                    </span>
                                </label>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        {{-- <div class="@if ($web_config['ref_earning_status']) col-sm-6 @else col-sm-12 @endif"> --}}
                        <div class="col-sm-12">
                            <div class="row g-3">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-3 input-icons mb-2 w-100 rounded bg-white">
                    ...
                    <div style="direction: {{ Session::get('direction') }}">
                        ...
                        <div class="text-black-50 mt-3 text-center">
                            <label>
                                <span class="fw-bold">{{  translate('Already_have_account?') }}</span>
