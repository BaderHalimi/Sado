<style>
    .mega_menu_inner:last-child h6 a {
        border-bottom: none !important;
    }

    .mega_menu_inner h6 a:hover {
        color: #ffc107;
    }

    /* .mega_menu_inner div:last-child a {
        border-bottom: none !important;
    } */
    .for-count-value {
        color: {
...
<header class="box-shadow-sm rtl __inline-10">
    ...
    <div class="topbar">
        <div class="container d-none d-sm-flex">
            <div>
                ...
                <div class="topbar-text dropdown disable-autohide {{Session::get('direction') === "rtl" ? 'ml-4' : 'ml-4'}}">
                    <a class="topbar-link dropdown-toggle" href="#" data-toggle="dropdown">
    ...
    <div class="navbar-sticky bg-light mobile-head">
        <div class="navbar navbar-expand-md navbar-light">
            <div class="container ">
                ...
                <a class="navbar-brand d-none d-sm-block {{Session::get('direction') === "rtl" ? 'mr-3' : 'mr-3'}} flex-shrink-0 __min-w-8rem py-0 my-0" href="{{route('home')}}">
                    <img class="__inline-" width="90"
                ...
                <a class="navbar-brand d-sm-none"
                    href="{{route('home')}}">
                    <img class="mobile-logo-img __inline-" width="60"
                        src="{{asset("storage/app/public/company")."/".$web_config['mob_logo']->value}}"
                        onerror="this.src='{{asset('public/assets/front-end/img/image-place-holder.png')}}'"
                        alt="{{$web_config['name']->value}}" />
                </a>
                <!-- Search-->
                <div class="input-group-overlay mx-lg-4 search-form-mobile col-md-5"
                    style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}}">
                ...
                <div class="navbar-toolbar d-flex flex-shrink-0 align-items-center">
                    ...
                    <div class="navbar-tool mx-3 mx-sm-0 open-search-form-mobile d-lg-none {{Session::get('direction') === "rtl" ? 'mr-md-3' : 'ml-md-3'}}">
                        <a class="btn bg-secondary px-2 py-1 px-sm-3 py-sm-3" href="#0">
                            <i class="tio-search" style="font-size: 16px; color: #307EC4 !important;"></i>
                        </a>
                    </div>

                    @if(auth('customer')->check())
                    <div class="dropdown">
                        <a class="btn bg-secondary px-2 py-1 px-sm-3 py-sm-3
                        {{-- dropdown-toggle --}}
                        " type="button" data-toggle="dropdown" aria-haspopup="true"
                            ...
                            {{-- <img width="100" src="{{asset('storage/app/public/profile/'.auth('customer')->user()->image)}}"
                ...
                <div class="dropdown">
                    <a class="btn bg-secondary px-2 py-1 px-sm-3 py-sm-3
                        {{-- dropdown-toggle --}}
                         {{Session::get('direction') === "rtl" ? 'mr-md-3' : 'ml-md-3'}}"
                        type="button" data-toggle="dropdown" aria-haspopup="true"
                        aria-expanded="false">
                        {{-- <div class="navbar-tool-icon-box bg-secondary">
                                    <div class="navbar-tool-icon-box bg-secondary"> --}}
                ...
                <div class="navbar-tool
                    {{-- dropdown --}}
                     d-none d-md-block {{Session::get('direction') === "rtl" ? 'mr-md-3' : 'ml-md-3'}}">
                    <a class="btn bg-secondary px-2 px-sm-3 py-1
                        {{-- dropdown-toggle --}}
                        ...
                        <i class="navbar-tool-icon czi-heart text-primary"></i>
                    </a>
                </div>
                <div id="cart_items">
        ...
        <div class="container px-10px">
            <div class="collapse navbar-collapse" id="navbarCollapse"
                ...
                <ul class="navbar-nav" style="{{Session::get('direction') === "rtl" ? 'padding-right: 0px' : ''}}">
                    ...
                    <li class="nav-item dropdown {{request()->is('/')?'active':''}}">
                        <a class="nav-link" href="{{route('room-list')}}">{{ translate('3D Room')}}</a>
                    </li>
                </ul>
                @if(auth('customer')->check())
    ...
    <div class="d-sm-block d-none navbar navbar-expand-md navbar-stuck-menu bg-white">
        <div class="container">
...
<script>
    ...
    $(".category-menu").find(".mega_menu").parents("li").addClass("has-sub-item").find("> a").append("<i class='czi-arrow-{{Session::get('direction') === "
        rtl " ? 'left' : 'right'}}'></i>");
