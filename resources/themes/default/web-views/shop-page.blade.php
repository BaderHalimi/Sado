    ...
    <div class="container py-4 __inline-67">
        ...
        {{-- <div class="d-flex flex-wrap gap-3 justify-content-sm-between py-4" dir="{{Session::get('direction') === "rtl" ? 'right' : 'left'}}"> --}}
            ...
            <div class="d-flex justify-content-between py-4">
                <!-- Static Filter Form -->
                <div class="d-sm-none col-2">
                    <div class="filter-show-btn btn btn--primary py-1 px-2 m-0 h-100">
                        <i class="tio-filter"></i>
                    </div>
                </div>
                <form class="col-sm-3 col-4 pr-3 pr-sm-0">
                    <div class="sorting-item" style="max-width: 100%; background-color: #F2F1F1 !important;">

                        <select class="w-100 py-2" onchange="sort_by_data(this.value)">
                ...
                <!-- shopView -->
                <form method="get" dir="rtl" class="col-sm-4 col-6" action="{{route('shopView',['id'=>$seller_id])}}">
                    <div class="search_form input-group search-form-input-group">
                        ...
                        <input type="text" class="form-control rounded-left" name="product_name" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}}; background-color: #F2F1F1 !important;" value="{{request('product_name')}}" placeholder="{{translate('search_products_from_this_store')}}">
