...
<script>
    ...
    function initAutocomplete() {
        var myLatLng = { lat: {{$shipping_latitude??'24.713431390469413'}}, lng: {{$shipping_longitude??'46.67515157829606'}} };

        const map = new google.maps.Map(document.getElementById("location_map_canvas"), {
            center: { lat: {{$shipping_latitude??'24.713431390469413'}}, lng: {{$shipping_longitude??'46.67515157829606'}} },
            zoom: 13,
            mapTypeId: "roadmap",
        });
