...
<div class="product-single-hover" style="{{isset($isRoomBuy) && $isRoomBuy == 1? 'background-color: #c7f2ff' : ''}}">
    <div class="overflow-hidden position-relative">
        <div class="inline_product clickable rtl"
            ...
            @endif
                <a href="{{isset($isRoom)? route('room-view',$product->id):route('product',$product->slug)}}">
                    <img src="{{ isset($isRoom)? '' : (\App\CPU\ProductManager::product_image_path('thumbnail'). '/')}}{{$product['thumbnail']}}"
        ...
        <div class="single-product-details">
            ...
            <div class="rating-show justify-content-between text-right px-3">
            ...
            <div class="justify-content-between text-right px-3">
                <div class="product-price text-right">
                    ...
                    @endif
                    <span class="text-accent" dir="rtl">
        ...
        <div class="text-center quick-view" >
            ...
            @elseif(isset($isRoom))
                <a class="btn btn--primary btn-sm" href="{{route('room-view',$product->id)}}">
                    <i class="czi-forward align-middle {{Session::get('direction') === "rtl" ? 'ml-1' : 'mr-1'}}"></i>
                    {{\App\CPU\translate('View')}}
                </a>
            @else
