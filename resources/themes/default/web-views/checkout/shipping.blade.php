    ...
    <div class="container py-4 rtl __inline-56 px-0 px-md-3"
        ...
        <div class="row mx-max-md-0">
            <div class="container px-2 px-sm-5">
                <div class="row justify-content-center align-items-center g-2">
                    <div class="col-md-12 mb-3">
                        <h3 class="font-weight-bold">{{ translate('enter_your_datails') }}</h3>
                    </div>
                </div>
            ...
            <section class="col-lg-8 px-max-md-0">
                <div class="checkout_details container">
                    <!-- Steps-->
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                            <div class="form-group">
                                                                <h4 class="text-primary">{{ translate('contact_info') }}
                                                                </h4>
                    ...
                    <div style="display: {{ $billing_input_by_customer ? '' : 'none' }}">
                        ...
                        <form method="post" class="card __card  mt-4" id="billing-address-form">
                            <div id="hide_billing_address" class="">
                                <ul class="list-group">

                                    <li class="list-group-item" onclick="billingAddress()">
                                        @if ($billing_addresses->count() >= 0)
                                        <div class="pb-3 d-flex align-items-center justify-content-between gap-3">
                                            <h4 class="mb-0 fs- text-primary">{{ translate('address') }}</h4>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-sm-6">
                                                            <label>{{ translate('address') }}<span
                                                                class="text-danger">*</span></label>
                                                            <div class="form-group">
                                                                <input id="pac-input-billing" class="form-control rounded"
                                                                    type="text" name="billing_address"
                                                                    placeholder="{{ translate('search_here') }}"                                                                 {{ $billing_addresses->count() == 0 ? 'required' : '' }}
                                                                    required/>
                                                                <div class="__h-200px" hidden id="location_map_canvas_billing"></div>
                                                            </div>
                                                            {{-- <input type="text" class="form-control"
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <select name="billing_country" id="billing_country"
                                                                    ...
                                                                    <option selected disabled value="-1">{{ translate('select one') }}</option>
...
@push('script')
    ...
    <script>
        ...
        function shipping_method_select(get_value) {
            ...
            $('#first_name').val(shipping_value.first_name);
            $('#last_name').val(shipping_value.last_name);
    ...
    <script>
        function initAutocomplete() {
            var myLatLng = {
                lat: 24.713431390469413,
                lng: 46.67515157829606
            };
    ...
    <script>
        function initAutocompleteBilling() {
            ...
            searchBox.addListener("places_changed", () => {
                ...
                places.forEach((place) => {
                    ...
                    geocoder.geocode({
                        ...
                        if (status === 'OK') {
                            if (results[0]) {
                                document.getElementById('billing_address').value = results[0]
                                    .formatted_address;
                                console.log(results[0].formatted_address);
                            }
                        }
            ...
            // Adding listener for enter key press in the search input
    ...
    <script>
        function checkout() {
            ...
            if (!billing_addresss_same_shipping) {
                billingData = {
                    billing_address: $('#pac-input-billing').val(),
                    billing_country: $('#billing_country').val(),
                    billing_city: $('#billing_city').val(),
                    billing_zip: $('#billing_zip').val(),
                    // billing_latitude: $('#billing_latitude').val(),
                    // billing_longitude: $('#billing_longitude').val()
                };
            }
            ...
            $.post({
                ...
                data: {
                    ...
                    shipping: physical_product === 'yes' ? shippingData : null,
                    billing: billing_addresss_same_shipping ? shippingData : billingData,
