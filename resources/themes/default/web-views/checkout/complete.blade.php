                ...
                <div class="card">
                    @if(auth('customer')->check() || session('guest_id'))
                        <div class="card-body">
                            <div class="mb-3">
                                <center>
                                    <i class="fa fa-check-circle __text-60px __color-0f9d58" style="transform: scale(1.5);"></i>
                                </center>
                            </div>
                            ...
                            <div class="row mt-4 justify-content-center text-center">
                                <div class="col-12 col-sm-6 text-center">
                                    <a href="{{ route('track-order.index') }}" class="btn btn--primary mb-3 text-center w-100">
                            ...
                            <div class="row mt-2 justify-content-center text-center">
                                ...
                                <div class="col-12 col-sm-6 text-center">
                                    <a href="{{route('home')}}" class="text-center w-100 btn btn-outline-primary">{{ translate('Continue_Shopping') }}</a>
                                </div>
                            </div>
                        </div>
                    @endif
