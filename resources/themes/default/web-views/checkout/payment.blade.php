...
@section('content')
    ...
    <div class="container pb-5 mb-2 mb-md-4 rtl px-0 px-md-3"
        ...
        <div class="row justify-content-center">
            <div class="col-md-11 mb-3 pt-3 px-max-md-0">
                                                    ...
                                                    <label class="m-0">
                                                        ...
                                                        <span
                                                            ...
                                                            <input type="radio" id="cash_on_delivery"
                                                                class="custom-radio">
                                                            <img width="20"
                                                                src="{{ asset('public/assets/front-end/img/icons/money.png') }}" />
                                            ...
                                            <div class="mt-3">
                                                <div class="card cursor-pointer">
                                                    <button
                                                        ...
                                                        <img width="20"
                                                            src="{{ asset('public/assets/front-end/img/icons/wallet-sm.png') }}" />
                                                ...
                                                <div class="border rounded px-4 py-2 mb-3">
                                                    <label
                                                        ...
                                                        <img width="30"
                                                            ...
                                                            src="{{ asset('storage/app/public/payment_modules/gateway_image') }}/{{ json_decode($payment_gateway->additional_data)->gateway_image != null ? json_decode($payment_gateway->additional_data)->gateway_image : '' }}"
                                                            alt="">
                                                        <span
                    ...
                    <div class="modal-body">
                        <form action="{{ route('offline-payment-checkout-complete') }}" method="post"
                            ...
                            <div class="d-flex justify-content-center mb-4">
                                <img width="52"
                                    src="{{ asset('public/assets/front-end/img/select-payment-method.png') }}"
                                    alt="">
                            </div>
...
@push('script')
    <script>
        ...
        function checkout() {
            // أضف تحقق للتأكد من عدم وجود منتجات من متجر مغلق مؤقتًا أو في وضع الإجازة
            $.get({
                url: "{{ route('cart.check-shop-status') }}",
                success: function(response) {
                    if (response.shop_closed) {
                        alert("هذا المتجر مؤقتًا مغلق أو في وضع الإجازة. لا يمكنك متابعة السداد.");
                    } else {
                        // إذا لم يكن هناك متاجر مغلقة، تابع إلى الخطوة التالية
