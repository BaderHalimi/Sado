                                ...
                                <ul class="list-group">
                                    ...
                                    <li class="list-group-item" onclick="billingAddress()">
                                        ...
                                        <div class="pb-3 d-flex align-items-center justify-content-between gap-3">
                                                <h4 class="mb-0 fs-18 text-capitalize">{{ translate('address') }}</h4>
                                                ...
                                                <div class="">
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-6">
                                                            <label>{{ translate('address') }}<span
                                                                    class="text-danger">*</span></label>
                                                            <input type="text" class="form-control" id="billing_address" name="billing_address" id="billing_address"
                                                                {{ $billing_addresses->count() == 0 ? 'required' : '' }} required/>
                                                        </div>
                                                        <div class="col-6">
                                                            <div class="form-group">
