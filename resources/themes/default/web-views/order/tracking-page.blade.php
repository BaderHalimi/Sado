                    ...
                    <form action="{{route('track-order.result')}}" type="submit" method="post" class="p-3">
                        ...
                        <div class="row g-3 flex-column align-items-center">
                            <div class="col-md-6 col-sm-6">
                                ...
                                <input class="form-control prepended-form-control" id="order_id" type="text" value="{{ old('order_id') }}" name="order_id"
                                    placeholder="{{translate('order_id')}}" required>
                            </div>
                         <div class="col-md-6 col-sm-6">
                             <label for="phone">{{translate('phone_number')}}</label>
                            <div class="input-group">
                                <input class="form-control prepended-form-control" type="text" id="phone" value="{{ old('phone_number') }}" name="phone_number"
                        ...
                        <div class="mt-5 pt-md-5 mx-auto text-center" style="max-width:377px;transform: scale(0.7);">
