                ...
                <div class="card-body">
                    <div class="row align-items-end">
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="form-group">
                                <label class="title-color d-flex align-items-center gap-2">
                                    {{translate('Default Room Commission')}}
                                    <span class="input-label-secondary cursor-pointer" data-toggle="tooltip" data-placement="right" title="{{translate('set_the_default_commission_amount_that_will_be_received_from_sellers_on_each_order')}}">
                                        <img width="16" src="{{asset('/public/assets/back-end/img/info-circle.svg')}}" alt="">
                                    </span>
                                </label>

                                @php($commission_room=\App\Model\BusinessSetting::where('type','sales_commission_room')->first())

                                <input type="number" class="form-control" name="commission_room" value="{{isset($commission_room)?$commission_room->value:0}}" placeholder="{{translate('ex: 70')}}" min="0" max="100">
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="form-group">
                                <label class="title-color d-flex align-items-center gap-2">
                                    {{translate('Default Room Price')}}
                                    <span class="input-label-secondary cursor-pointer" data-toggle="tooltip" data-placement="right" title="{{translate('set_the_default_commission_amount_that_will_be_received_from_sellers_on_each_order')}}">
                                        <img width="16" src="{{asset('/public/assets/back-end/img/info-circle.svg')}}" alt="">
                                    </span>
                                </label>

                                @php($commission_price=\App\Model\BusinessSetting::where('type','sales_commission_price')->first())

                                <input type="number" class="form-control" name="commission_price" value="{{isset($commission_price)?$commission_price->value:0}}" placeholder="{{translate('ex: 70')}}" min="0">
