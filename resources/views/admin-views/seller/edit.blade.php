        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                <form action="{{route('admin.sellers.update',[$seller->id])}}" method="post"
                      enctype="multipart/form-data" id="admin-sellers-form">
                @csrf
                <!-- Card -->
                    <div class="card mb-3 mb-lg-5" id="generalDiv">
                        <!-- Profile Cover -->
                        <div class="profile-cover">
                        @php($sellers = $seller ? asset('storage/app/public/shop/banner/'.$seller) : 'https://images.pexels.com/photos/866398/pexels-photo-866398.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1')

                            <div class="profile-cover-img-wrapper" style="background-image: url({{ $sellers }}); background-repeat: no-repeat; background-size: cover;">
                            </div>
                        </div>
                        <!-- End Profile Cover -->
                    ...
                    <div class="card mb-3 mb-lg-5">
                        ...
                        <div class="card-body">
                                ...
                                <div class="col-sm-9">
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" name="f_name" value="{{$seller->f_name}}" class="form-control"
                                                id="name"
                                                required>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <label for="name" class="title-color">{{translate('last_Name')}} <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" name="l_name" value="{{$seller->l_name}}" class="form-control"
                                                id="name"
                                                required>
                                        </div>
                                    </div>
                            ...
                            <div class="d-flex justify-content-end">
                                <button type="button"
                                        onclick="{{env('APP_MODE')!='demo'?"form_alert('admin-sellers-form','Want to update seller info ?')":"call_demo()"}}"
                ...
                <div id="passwordDiv" class="card mb-3 mb-lg-5">
                    ...
                    <div class="card-body">
                        <!-- Form -->
                        <form id="changePasswordForm" action="{{ route('admin.sellers.settings-password', ['id' => $seller->id]) }}"
                              method="post"
