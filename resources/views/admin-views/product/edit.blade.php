    ...
    <div class="content container-fluid">
        ...
        <form class="product-form text-start" action="{{route('admin.product.update',$product->id)}}" method="post" enctype="multipart/form-data" id="product_form">
            ...
            <div class="card mt-3 rest-part">
                ...
                <div class="card-body">
                    <div id="model_loading" class="loading-div">
                        <img src="{{asset('/public/assets/back-end/img/loader.gif')}}" />
                    </div>
                    <div id="model_part" class="row">
                        <!-- <div class="col-md-6">
                            <div class="d-flex justify-content-center">
                                <div class="form-group w-100">
                                    <div class="d-flex align-items-center justify-content-between gap-2">
                                    ...
                                    <div>
                                        <div class="custom_upload_input">
                                            <input type="file" name="model_texture" class="custom-upload-input-file meta-img" id="" data-imgpreview="pre_model_texture_viewer" onchange="uploadColorImage(this)">

                                            <span class="delete_file_input btn btn-outline-danger btn-sm square-btn"
                                            style="display: @if (File::exists(base_path('storage/app/public/product/model/'. $product['texture']))) flex @else none @endif">
                                                <i class="tio-delete"></i>
                                            </span>

                                            <div class="img_area_with_preview position-absolute z-index-2">
                                                <img id="pre_model_texture_viewer" class="h-auto aspect-1 bg-white" src="{{ asset("storage/app/public/product/model/". $product['texture'])}}" onerror="this.classList.add('d-none')">
                                            </div>
                                            <div class="position-absolute h-100 top-0 w-100 d-flex align-content-center justify-content-center">
                                                <div class="d-flex flex-column justify-content-center align-items-center">
                                                    <img src="{{asset('public/assets/back-end/img/icons/product-upload-icon.svg')}}" class="w-50">
                        ...
                        <div class="col-md-6">
                            <div class="d-flex justify-content-center">
                                <div class="form-group w-100">
                                    ...
                                    <div>
                                        <div class="custom_upload_input">
                                            <input type="file" name="model" class="custom-upload-input-file meta-img" id="" data-imgpreview="pre_model_viewer" onchange="uploadColorImage(this)">

                                            <span class="delete_file_input btn btn-outline-danger btn-sm square-btn"
                                            style="display: @if (File::exists(base_path('storage/app/public/product/model/'. $product['model']))) flex @else none @endif">
                                                <i class="tio-delete"></i>
                                            </span>

                                            <div class="img_area_with_preview position-absolute z-index-2">
                                                <img id="pre_model_viewer" class="h-auto aspect-1 bg-white" src="{{ asset("storage/app/public/product/model/". $product['model'])}}" onerror="this.classList.add('d-none')">
                                            </div>
                                            <div class="position-absolute h-100 top-0 w-100 d-flex align-content-center justify-content-center">
                                                <div class="d-flex flex-column justify-content-center align-items-center">
                                                    <img src="{{asset('public/assets/back-end/img/icons/product-upload-icon.svg')}}" class="w-50">
...
@push('script_2')
    ...
    <script>
        let model_loading = $("#model_loading")
        let model_part = $("#model_part")
        model_loading.hide()
        function check() {
            model_loading.show()
            model_part.hide()
            ...
            let submit_status = 1;
            console.log("---post ajax status---: ", submit_status);
            ...
            if(submit_status == 1)
            {
                ...
                $.post({
                    ...
                    onUploadProgress: (progressEvent) => {
                        ...
                        // Update your progress bar or display the progress percentage
                    },
                    success: function (data) {
                        model_loading.hide()
                        model_part.show()
