                    ...
                    <div class="row align-items-end">
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <input type="number" min="0" step="0.01"
                                        ...
                                        value="{{ \App\CPU\Convert::default($room->unit_price) }}"
                                        class="form-control" required readonly>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3 physical_product_show" id="quantity">
                            <div class="form-group">
                                ...
                                <input type="number" min="0" value="1000000" step="1" placeholder="{{ translate('quantity') }}" name="current_stock" id="current_stock_qty" class="form-control" required>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
...
<!--</div>-->
        <input type="hidden" min="0" value="0" step="1" placeholder="{{ translate('shipping_cost') }}" name="shipping_cost" class="form-control" required>
                        ...
                        <!--    </div>-->
                        <!--</div>-->
                                <input type="hidden" name="multiplyQTY" id="multiplyQTYHidden" value="0">
                                ...
                                <div>
                                    <div class="custom_upload_input">
                                        <input type="file" name="image" class="custom-upload-input-file" id="" data-imgpreview="pre_img_viewer"
                                            ...
                                            value="{{$room->thumbnail}}"
                                            onchange="uploadColorImage(this)">
                                        <input type="text" name="image1" class="d-none" value="{{$room->thumbnail}}"/>
                                        <span class="delete_file_input btn btn-outline-danger btn-sm square-btn"
                                        style="display: @if (File::exists(base_path('storage/app/public/product/thumbnail/'. $room->thumbnail))) flex @else none @endif">
                                            <i class="tio-delete"></i>
                                        </span>

                                        <div class="img_area_with_preview position-absolute z-index-2">
                                            <img id="pre_img_viewer" class="h-auto aspect-1 bg-white" src="{{\App\CPU\ProductManager::product_image_path('thumbnail').'/'.$room->thumbnail}}" onerror="this.classList.add('d-none')">
                                        </div>
                        ...
                        <div class="card h-100">
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <div id="color_wise_image" class="row g-2">
                                        <div class="col-12">
...
@push('script')
    ...
    <script>
        ...
        var colors = 0;
        var imageCount = 0;
        var thumbnail = '{{\App\CPU\ProductManager::product_image_path('thumbnail').'/'.$room->thumbnail??asset('public/assets/back-end/img/400x400/img2.jpg')}}';
        $(function () {
            if (imageCount > 0) {
                $("#coba").spartanMultiImagePicker({
                    fieldName: 'images[]',
              ...
              $("#thumbnail").spartanMultiImagePicker({
                ...
                maxFileSize: '',
                placeholderImage: {
                    image: '{{\App\CPU\ProductManager::product_image_path('thumbnail').'/'.$room->thumbnail??asset('public/assets/back-end/img/400x400/img2.jpg')}}',
                    width: '100%',
                },
                dropFileLabel: "Drop Here",
                onAddRow: function (index, file) {
