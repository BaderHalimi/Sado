...
@section('content')
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center flex-wrap gap-5">
                            ...
                            <div class="">
                                 <div class="flex-start">
                                    <h6>{{translate('registry_Num')}} : </h6>
                                    <h6 class="mx-1">{{$shop->registry_Num}}</h6>
                                </div>
                                <div class="flex-start">
    <span class="key">{{ translate('PDF_Document') }}</span>
    <span>:</span>
    @if($shop->pdf_document)
        <a href="{{ asset('storage/app/' . $shop->pdf_document) }}" target="_blank" class="badge badge badge-warning">{{ translate('View PDF') }}</a>
    @else
    ...
    <span>:</span>
    @if($shop->pdf_documents)
        <a href="{{ asset('storage/app/' . $shop->pdf_documents) }}" target="_blank" class="badge badge-info" >{{ translate('Viewـcertificate') }}</a>
    @else
        {{ translate('not_available') }}
    @endif
</div>
