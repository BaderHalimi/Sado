            ...
            <div class="card mt-3 rest-part">
                ...
                <div class="card-body">
                    <div class="row align-items-end">
                        ...
                        <!--    </div>-->
                        <!--</div>-->
                                                        <input type="hidden" min="0" value="0" step="1" placeholder="{{ translate('shipping_cost') }}" name="shipping_cost" class="form-control" required>

               <!-- قسم تكلفة الشحن مخفي -->
<div class="col-md-6 physical_product_show" id="shipping_cost_multy" >
        ...
        <div class="form-control h-auto min-form-control-height d-flex align-items-center flex-wrap justify-content-between gap-2">
            ...
            <div>
                <label class="switcher">
                    <input type="checkbox" class="switcher_input" name="multiplyQTY" hidden>
                            ...
                            <div class="d-flex justify-content-center">
                                <div class="form-group w-100">
                                    <div class="d-flex align-items-center justify-content-between gap-2">
                                        <div>
                                            <label class="title-color" for="model_texture">
                                                {{ translate('3D Model Texture') }}
                                            </label>
                                    ...
                                    <div>
                                        <div class="custom_upload_input">
                                            <input type="file" name="model_texture" class="custom-upload-input-file meta-img" id="" data-imgpreview="pre_model_texture_viewer"
                                            ...
                                            <div class="img_area_with_preview position-absolute z-index-2">
                                                <img id="pre_model_texture_viewer" class="h-auto bg-white" src="img" onerror="this.classList.add('d-none')">
                                            </div>
                                            <div class="position-absolute h-100 top-0 w-100 d-flex align-content-center justify-content-center">
                                                <div class="d-flex flex-column justify-content-center align-items-center">
                                                    <img src="{{asset('public/assets/back-end/img/icons/product-upload-icon.svg')}}" class="w-50">
                                                    <h3 class="text-muted">{{ translate('Upload Texture') }}</h3>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    <div class="d-flex justify-content-center">
        <div class="form-group w-100">
            <div class="d-flex align-items-center justify-content-between gap-2">
                <div>
                    <label class="title-color" for="model">
                        {{ translate('3D Model OBJ') }}
                    </label>
                    <span class="input-label-secondary cursor-pointer">
                        <img src="{{asset('/public/assets/back-end/img/info-circle.svg')}}" alt="">
                    </span>
            ...
            <div>
                <div class="custom_upload_input">
                    <input type="file" name="model" class="custom-upload-input-file" id="model" accept=".glb" onchange="uploadFile(this)">
                    <span class="delete_file_input btn btn-outline-danger btn-sm square-btn" style="display: none">
                        <i class="tio-delete"></i>
                    </span>
                    <div class="img_area_with_preview position-absolute z-index-2">
                        <img id="pre_model_viewer" class="h-auto bg-white" src="img" onerror="this.classList.add('d-none')">
                    </div>
                    <div class="position-absolute h-100 top-0 w-100 d-flex align-content-center justify-content-center">
                        <div class="d-flex flex-column justify-content-center align-items-center">
                            <img src="{{asset('public/assets/back-end/img/icons/product-upload-icon.svg')}}" class="w-50">
                            <h3 class="text-muted">{{ translate('Upload Model OBJ') }}</h3>
                        </div>
                    </div>
                </div>
            </div>
  ...
  <div id="progress-bar-containertwo" style="display:none;">
                <div id="progress-two" style="width: 0%; height: 20px; background-color: blue;"></div>
            </div>
...
@push('script')
    ...
    function uploadFile(input) {
        ...
        formData.append('model', file); // تغيير 'model_zip' إلى 'model'

        const xhr = new XMLHttpRequest();
        xhr.open('POST', '{{ route('admin.product.store') }}', true);
        ...
        if (result.value) {
            ...
            if (submit_status === 1) {
                ...
                toastr.info('جاري التحديث...', {
                    timeOut: 0, // Keep the toast displayed
                    extendedTimeOut: 0,
                    closeButton: false,
                    progressBar: true
                });
                ...
                $.ajax({
                    ...
                    processData: false,
                    beforeSend: function() {
                        document.getElementById('progress-bar-containertwo').style.display = 'block';
                        document.getElementById('progress-two').style.width = '0%';
                    },
                    xhr: function() {
                        ...
                        xhr.upload.addEventListener("progress", function(evt) {
                            if (evt.lengthComputable) {
                                ...
                                document.getElementById('progress-two').style.width = percentComplete * 100 + '%';
                            }
                        }, false);
                        return xhr;
                    },
                    success: function(data) {
                        document.getElementById('progress-bar-containertwo').style.display = 'none';
                        toastr.clear(); // إزالة رسالة التحميل
                        if (data.errors) {
