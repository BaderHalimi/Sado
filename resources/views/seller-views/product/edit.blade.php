                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <input type="number" min="0" step="0.01"
                                        ...
                                        value={{ \App\CPU\Convert::default($product->purchase_price) }} required required @if($product->room_id > 0) disabled @endif>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <input type="number" min="0" step="0.01"
                                        ...
                                        value={{\App\CPU\Convert::default($product->unit_price)}} required required @if($product->room_id > 0) disabled @endif>
                            </div>
                        </div>
