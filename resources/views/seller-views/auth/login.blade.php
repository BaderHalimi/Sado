...
<main id="content" role="main" class="main">
    ...
    <div class="container py-5 py-sm-7">
        ...
        <a class="d-flex justify-content-center mb-5" href="javascript:">
            <img class="z-index-2" height="113" src="{{asset("storage/app/public/company/".$e_commerce_logo)}}" alt="Logo"
            ...
            <div class="container">
                ...
                <div class="card card-lg mb-5">
                    <div class="card-body px-0 px-sm-5">
                        <!-- Form -->
                        <form id="form-id" class="container px-sm-5" action="{{route('seller.auth.login')}}" method="post">
                            @csrf
                            ...
                            <div class="js-form-message form-group">
                                <label class="input-label" for="signinSrEmail">{{translate('email_address_or_phone_number')}}</label>

                                <input type="email" class="form-control form-control-lg" name="email" id="signinSrEmail"
                                       tabindex="1" placeholder="{{translate('enter_email_address_or_phone_number')}}" aria-label="email@address.com"
                                       required data-msg="Please enter a valid email address.">
                            </div>
                            <!-- End Form Group -->

                            <!-- Form Group -->
                            <div class="js-form-message form-group mb-1 pb-1">
                                ...
                                <div class="input-group input-group-merge">
                                    <input type="password" class="js-toggle-password form-control form-control-lg"
                                           name="password" id="signupSrPassword" placeholder="{{translate('enter_password')}}"
                            ...
                            @if(isset($recaptcha) && $recaptcha['status'] == 1)
                                ...
                                <br/>
                            @else
                                <div class="container row mb-5 mt-0">
                            ...
                            <button type="submit" class="btn btn-lg btn-block btn--primary w-100 my-5">{{translate('sign_in')}}</button>
                            <div class="text-center" style="font-size: large; font-weight: bold;">{{ translate('Don’t_have_account?') }} <a href="{{ route('shop.apply') }}">{{ translate('register_now') }}</a></div>
                        </form>
                        <!-- End Form -->
                    </div>
