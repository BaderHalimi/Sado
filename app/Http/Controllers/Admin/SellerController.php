...
use App\CPU\ImageManager; // استيراد الكلاس ImageManager
...
class SellerController extends Controller
{
    ...
    public function delete($id)
    {
        ...
        $seller->delete();
        Toastr::success(translate('seller_deleted_successfully'));
        return back();
    }
...
public function update(Request $request, $id)
{
    ...
    // Find the seller based on the provided $id
    $seller = Seller::find($id);

    // Check if the seller is found
    if (!$seller) {
        // Handle the case where the seller is not found, for example, redirect or show an error message.
    ...
    Toastr::info(translate('Profile updated successfully'));
    return back();
}



public function settings_password_update(Request $request, $id)
{
    $request->validate([
    ...
    Toastr::success(translate('Seller password updated successfully'));
    return back();
}
