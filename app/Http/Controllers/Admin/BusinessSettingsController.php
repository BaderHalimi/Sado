...
class BusinessSettingsController extends Controller
{
    ...
    public function seller_settings()
    {
        ...
        $sales_commission_room = BusinessSetting::where('type', 'sales_commission_room')->first();
        if (!isset($sales_commission_room)) {
            DB::table('business_settings')->insert(['type' => 'sales_commission_room', 'value' => 0]);
        }

        $sales_commission_price = BusinessSetting::where('type', 'sales_commission_price')->first();
        if (!isset($sales_commission_price)) {
            DB::table('business_settings')->insert(['type' => 'sales_commission_price', 'value' => 0]);
        }
    ...
    public function update_seller_settings(Request $request)
    {
        ...
        $request->validate([
            ...
            'commission_room' => 'required|min:0',
            'commission_price' => 'required|min:0',
        ]);

        // dd($request->commission_room);
        // sales_commission
        ...
        // sales_room_commission
        BusinessSetting::updateOrInsert(['type' => 'sales_commission_room'], [
            'value' => $request->commission_room ?? 0,
            'updated_at' => now()
        ]);
        
        // sales_room_price_commission
        BusinessSetting::updateOrInsert(['type' => 'sales_commission_price'], [
            'value' => $request->commission_price ?? 0,
            'updated_at' => now()
        ]);
