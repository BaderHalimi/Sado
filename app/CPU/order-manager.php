...
class OrderManager
{
    ...
    public static function generate_order($data)
    {
        ...
        // Your API endpoint
        $apiEndpoint = 'https://starlinksapi.app/api/v1/shipments';
        ...
        $address_id = session('address_id') ? session('address_id') : (json_decode($data['additional_data'], true)['address_id'] ?? null);
        $billing_address_id = session('billing_address_id') ? session('billing_address_id') : (json_decode($data['additional_data'], true)['billing_address_id'] ?? null);
        ...
        $or = [
            ...
            'billing_address_data' => ShippingAddress::find($address_id),
        ...
        $consignee_address = '{
                ...
                "company": "",
                "address1": "'.$or['billing_address_data']['address'].'",
                "address2": "",
                "address3": "",
                "city": "'.$or['billing_address_data']['city'].'",
                "state": "'.$or['billing_address_data']['state'].'",
                "zip": "'.$or['billing_address_data']['zip'].'",
                "country": "SA",
                "phone": "'.$or['billing_address_data']['phone'].'",
                "email": "'.$or['billing_address_data']['email'].'",
                "vat": "32197482341410",
                "id_number": "'.$or['billing_address_data']['id'].'",
                "customs_data": {
                    "eori_number": "",
                    "ioss_number": ""
                },
        ...
        // $shipper_address = '{
        //     "name": "'.$or['shipping_address_data']['contact_person_name'].'",
        //     "company": "",
        //     "address1": "'.$or['shipping_address_data']['address'].'",
        //     "address2": "",
        //     "address3": "",
        //     "city": "'.$or['shipping_address_data']['city'].'",
        //     "state": "'.$or['shipping_address_data']['state'].'",
        //     "zip": "'.$or['shipping_address_data']['zip'].'",
        //     "country": "GB",
        //     "phone": "'.$or['shipping_address_data']['phone'].'",
        //     "email": "'.$or['shipping_address_data']['email'].'",
        //     "vat": "32197482341410",
        //     "id_number": "'.$or['shipping_address_data']['id'].'",
        //     "customs_data": {
        //         "eori_number": "",
        //         "ioss_number": ""
        //     },
        ...
        //                     "hs_code": "51051000",
        //                     "image_url": "https://upload.wikimedia.org/wikipedia/commons/thumb/2/2f/Google_2015_logo.svg/1024px-Google_2015_logo.svg.png",
        //                     "parcel_item_extra": {
        //                             "extra_field_1": "Yellow flower",
        //                             "extra_field_2": "",
        //                             "extra_field_3": ""
        //                         }
        //                 }
...
//        confirmed
        ...
        foreach (CartManager::get_cart($data['cart_group_id']) as $c) {
            ...
            $parcels .= '{
                    ...
                    "weight": "1",
                    "quantity": "'.$c['quantity'].'",
                    "country_of_origin": "SD",
                    "hs_code": "51051000",
                    "image_url": "'.\App\CPU\ProductManager::product_image_path('thumbnail').'/'.$product['thumbnail'].'",
                    "parcel_item_extra": {
                        "extra_field_1": "",
                        "extra_field_2": "",
                        "extra_field_3": ""
        ...
        //     "company": "",
        //     "address1": "Al Murabba",
        //     "address2": "Prince Faisal Bin Turki Bin Abdul Aziz Rd",
        //     "address3": "",
        //     "city": "Riyadh",
        //     "state": "Riyadh",
        //     "zip": "",
        //     "country": "SA",
        //     "phone": "+966 011 123 4566",
        //     "email": "John@mail.net",
        //     "vat": "32197482341410",
        //     "id_number": "RT123456789GH",
        //     "customs_data": {
        //     "eori_number": "GB123456",
        //     "ioss_number": "GB123456"
        //     },
        //     "address_extra": {
        //     "extra_field_1": "Yellow flower shop",
        //     "extra_field_2": "",
        //     "extra_field_3": ""
        //     },
        //     "address_code": {
        ...
        //     {
        //         "name": "Jane Smith",
        //         "company": "Clothing retailer ltd.",
        //         "address1": "Great Russel st. 5",
        //         "address2": "12A",
        //         "address3": "B2",
        //         "city": "London",
        //         "state": "London",
        ...
        $jsonData = '{
            ...
            "invoice": "AB12221241",
            "description": "Save Store Payment.",
            "incoterm": "DDU",
            "value": "'.$or['order_amount'].'",
            "currency": "SAR",
            "cod_value": "'.$or['order_amount'].'",
            "cod_currency": "SAR",
            "is_dangerous": "1",
    ...
    public static function order_insert($order_data) : int
    {
        ...
        $or = [
            ...
            'billing_address_data' => ShippingAddress::find($order_data['address_id']),
